...
%define tmd5sum1	883631989e54e204a069801f9a750749
%define downurl2	http://linuxdownload.adobe.com/linux/i386/flash-plugin-%{version}-release.i386.rpm
%define tmd5sum2	4b4d0bde600c041ab37b4deaeea7b6b3
%define downurl3	%nil
%define tmd5sum3	%nil
